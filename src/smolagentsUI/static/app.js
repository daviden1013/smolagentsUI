...
function renderStep(stepNumber, modelOutput, code, logs, images, error) {
    ...
    // --- Generate Summary Layout (Modified) ---
    // Wrapper to stack Step Label and Preview vertically
    ...
    if (modelOutput) {
        ...
        let text = modelOutput.replace(/\s+/g, ' ').trim();
        ...
        if (text) {
            ...
            // Styling for "generated by agent" look: Monospace, lighter color, new line
